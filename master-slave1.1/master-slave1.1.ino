...
void loop() {
  ...
  if (millis() - lastSendTime > interval) {
      ...
      if (inbox != ""){
        ...
        inboxmessage += String(" From node 1: ");
        inboxmessage += fromnode1;
        inboxmessage += String(" From node 2: ");
      ...
      sendmessage(dataString, inboxmessage, localAddress, baza);
      //save file
...
void sendmessage(String outgoing, String inboxmessage, byte sender, byte destination){
